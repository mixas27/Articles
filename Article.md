Многие проекты, использующие для аутентикации пользователей Spring Security, сталкиваются со следующей проблемой: при входе в приложение с использованием «remember me»,  пользователей то и дело разлогинивает с выбросом  **__CookieTheftException__**. Так, подобная проблема была найдена на багтрекере  [Atlassian](https://jira.atlassian.com/browse/STASH-3054) и [Grails](https://jira.grails.org/browse/GPSPRINGSECURITYCORE-70). Не обошла она стороной и наш родной [Javatalks](http://jira.jtalks.org/browse/JC-1743).
